...
def compute_implied_delta_torch(
    *,
    ...
    # Resolve model function arguments from merged state
    ...
    # Resolve optional reference tensor for normalization
    ...
    if implied_balance_fn_torch is not None:
        ...
        try:
            return normalize_discrepancy_torch(raw, scale_a, scale_b, ref=ref_tensor)
        except Exception:  # noqa: BLE001
            return None
    ...
    try:
        raw = pred - implied_t
        return normalize_discrepancy_torch(raw, pred, implied_t, ref=ref_tensor)
    except Exception:  # noqa: BLE001
        return None
